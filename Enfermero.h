...
namespace Interfaz4 {
	...
	private: System::Windows::Forms::Button^ bRegisPac;
	protected:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bRegisPac = (gcnew System::Windows::Forms::Button());
			...
			// bRegisPac
			// 
			this->bRegisPac->Location = System::Drawing::Point(170, 87);
			this->bRegisPac->Name = L"bRegisPac";
			this->bRegisPac->Size = System::Drawing::Size(151, 23);
			this->bRegisPac->TabIndex = 1;
			this->bRegisPac->Text = L"Registrar datos del paciente";
			this->bRegisPac->UseVisualStyleBackColor = true;
			this->bRegisPac->Click += gcnew System::EventHandler(this, &Enfermero::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Enfermero::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Enfermero::button3_Click);
			// 
			// button4
			// 
			...
			this->Controls->Add(this->bRegisPac);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		RegistrarPaciente^ regis = gcnew RegistrarPaciente();
		regis->ShowDialog(); // Mostrar el formulario como un cuadro de diálogo modal
		// regis->Show();    // Alternativamente, usar esto para un formulario no modal
	}

private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	Triaje^ triaje = gcnew Triaje();
	triaje->ShowDialog(); // Mostrar el formulario como un cuadro de diálogo modal
	// regis->Show();    // Alternativamente, usar esto para un formulario no modal
}
